...
![Grammarly suggesting corrections in a LaTeX document](/images/blog/vs_code_1.jpg)
...
3. Search for [LaTeX Workshop](https://marketplace.visualstudio.com/items?itemName=James-Yu.latex-workshop) and install it.
    ...
    ![LaTeX Workshop build and view commands in VS Code](/images/blog/vs_code_4.jpg)
...
![Grammarly commands in the VS Code command palette](/images/blog/vs_code_3.jpg)
