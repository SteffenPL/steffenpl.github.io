...
- **S. Plunder, [S. Merino-Aceituno]()**, _Convergence proof for first-order position-based dynamics: An efficient scheme for inequality constrained ODEs._ **(2023)** [arxiv](https://arxiv.org/abs/2310.01215).
...
The simulation above uses a very simple numerical method. In fact, [Matthias Muller](https://matthias-research.github.io/pages/challenges/challenges.html)
...
<div class="mx-auto">
    ...
    <source type="video/mp4" src="/assets/videos/000_pbd_small_dt.mp4">
    </video>
</div>

<div class="mx-auto">
    <video width="320" class="mx-auto pt-8" autoplay loop>
    <source type="video/mp4" src="/assets/videos/003_pbd_large_dt.mp4">
    </video>
</div>
</div>
