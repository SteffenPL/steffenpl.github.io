...
<img class="max-w-xs md:float-right mx-auto md:mx-0" src="/images/blog/EMT/model_simple.png" alt="EMT model diagram">
...
To see the model in action, we developed a standalone online simulator: [semtor.github.io](https://semtor.github.io/). Try it out!

<video src="/videos/semtor.mp4" class="max-w-full mx-auto" controls autoplay loop muted></video>
...
that [position-based dynamics](/blog/position-based-dynamics) was with quite some margin the fastest method for our model.

The model is (roughly) of the form
$$
\dot z = f(z,t) + \sum_k \lambda_k \nabla_z g_k(z, t)
$$
with the conditions
$$
...
<video class="max-w-full" controls autoplay loop muted>
<source src="/videos/sim_a6_b24_concave.mp4" type="video/mp4">
</video>
</div>
...
Our method of choice is the rather novel [position-based dynamics (PBD)](/blog/position-based-dynamics).
